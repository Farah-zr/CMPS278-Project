...
function Brownies() {
    ...
    useEffect(() => {
        axios
          .get(`https://localhost:7277/api/Brownies`)
          .then((res) => {
            setItems(res.data);
          })
          .catch((error) => {
                                    ...
                                    <>
                                            ...
                                            <Card sx={{ width: 200, height: 270, m: 2, backgroundColor: "#fffffe" }}>
                                                <CardActionArea component={Button} sx={{ textTransform: 'capitalize', height: 'fitContent' }} onClick={handleClickOpen()}>
                                                    <CardMedia
                                                        component="img"
                                                        height="130"
                                                        image={require("../../img/brownies/" + item.id + ".jpg")}
                                                        alt="food" />
                                        ...
                                        >
                                            <DialogContent dividers={true}>
                                                <div>
                                                    <img src={require("../../img/brownies/" + item.id + ".jpg")} alt="food" height="350" width="100%" style={{ borderRadius: '8px' }} />
                                                </div>
                                                <DialogContentText>
