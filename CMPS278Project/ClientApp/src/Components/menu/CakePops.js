...
function CakePops() {
    ...
    useEffect(() => {
        axios
          .get(`https://localhost:5001/api/CakePops`)
          .then((res) => {
            setItems(res.data);
          })
          .catch((error) => {
                                            ...
                                            <Card sx={{ width: 200, height: 270, m: 1, backgroundColor: "#fffffe" }}>
                                                <CardActionArea component={Button} sx={{ textTransform: 'capitalize', height: 'fitContent' }} button-key={item.id} onClick={(e) => handleClickOpen(e)}>
                                                    <CardMedia
                                                        component="img"
                                                        height="130"
                                                        image={require("../../img/cakePops/" + item.id + ".jpg")}
                                                        alt="food" />
                                  ...
                                  .map((filteredItem) => (
                                    ...
                                    >
                                        <DialogContent dividers={true}>
                                            <div>
                                                <img src={require("../../img/cakePops/" + filteredItem.id + ".jpg")} alt="food" height="350" width="100%" style={{ borderRadius: '5px' }} />
                                            </div>
                                            <DialogContentText>
