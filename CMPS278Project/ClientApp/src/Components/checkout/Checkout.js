                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    <div>
                        <Box sx={{ backgroundColor: '#fffffe', boxShadow: '0px 0px 20px rgba(0, 0, 0, 0.4)', borderRadius: '5px', mx: 5, my: 3, p: 1 }}>
                            <Typography variant="h6" sx={{ fontSize: 16, fontWeight: 600, mb:1, ml:1 }}>
                                Delivery Time 
                            </Typography>
                            <div style={{ display: 'flex' }}>
                                &emsp;<DeliveryDiningIcon sx={{ color: '#EF9DAA', fontSize: 'x-large', pb:0.5 }} />
                        ...
                        <Box sx={{ backgroundColor: '#fffffe', boxShadow: '0px 0px 20px rgba(0, 0, 0, 0.4)', borderRadius: '5px', mx: 5, my: 3, p: 1 }}>
                            ...
                            <div style={{ display: 'flex' }}>
                                &emsp;<PlaceIcon sx={{ color: '#EF9DAA', fontSize: 'x-large', pb:0.5 }} />
                                <Typography variant="body2" sx={{ ml:0.5, fontSize: 14 }}>
                        ...
                        <Box sx={{ backgroundColor: '#fffffe', boxShadow: '0px 0px 20px rgba(0, 0, 0, 0.4)', borderRadius: '5px', mx: 5, my: 3, p: 1 }}>
                            ...
                            <div style={{ display: 'flex' }}>
                                &emsp;<AttachMoneyIcon sx={{ color: '#EF9DAA', fontSize: 'x-large', pb:0.5 }} />
                                <Typography variant="body2" sx={{ ml:0.5, fontSize: 14 }}>
                                    Cash
                                </Typography>
                            </div>                  
                    ...
                    <div className="place-order-btn">
                        <ColorButton variant="contained" component={Link} to="/thanku" sx={{ mx: 5, my: 3, p: 1, width: '85%' }}>Place Order</ColorButton>
                    </div>
                </Box>
            </Box>
        </Container>
