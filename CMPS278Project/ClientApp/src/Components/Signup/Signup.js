    ...
    return(
        <div className="foodcontainer" style={{ backgroundColor: '#232946' }}>
            <Container maxWidth="sm">
                <Box sx={{ backgroundColor: '#fffffe', position: 'relative', top: '3%', left: '10%', height: '93%', width: '70%', mx: 5, p:2, alignItems: 'center', boxShadow: '0px 0px 20px rgba(0, 0, 0, 0.4)', borderRadius: '7px' }}>
                    <Typography variant="h4" sx={{ textAlign: 'center', fontWeight: 600, pt: 4, pb: 2, color: '#EF9DAA', height: '100px' }}>
                        Sign Up
                    </Typography>
                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center', margin: '20px' }}>
                        <FormControl variant="standard" sx={{ width: '300px', mx: 1, my: 1 }}>
                        ...
                        <FormControl variant="standard" sx={{ width: '300px', mx: 1, mb: 1 }}>
