...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        builder.Entity<CakePop>().ToTable("CakePops").HasData(
            new MenuItem { Id = 1, Name = "Chocolate Caramel", Description = "moist and fudgy chocolate cake pop filled with caramel toffee dipped in chocolate and topped with salted crushed pretzels", Price = 50000 },
            new MenuItem { Id = 2, Name = "The Peanut Butter Chocolate", Description = "moist and fudgy chocolate cake pop filled with peanut butter dipped in chocolate and topped with caramelized peanut brittle", Price = 50000 },
            new MenuItem { Id = 3, Name = "Rainbow Cake Pop", Description = "", Price = 50000 },
            new MenuItem { Id = 4, Name = "Chocolate", Description = "chocolate cake pop dipped in milk chocolate", Price = 45000 },
            new MenuItem { Id = 5, Name = "Vanilla", Description = "vanilla cake pop dipped in white chocolate", Price = 45000 },
            new MenuItem { Id = 6, Name = "Cookie Dough Nutella", Description = "cookie dough cake pop filled with nutella dipped in milk chocolate", Price = 55000 },
            new MenuItem { Id = 7, Name = "Red Velvet", Description = "red velvet cake pop dipped in milk chocolate", Price = 45000 },
            new MenuItem { Id = 8, Name = "Cookie Dough", Description = "cookie dough cake pop dipped in milk chocolate", Price = 46000 },
            new MenuItem { Id = 9, Name = "Red Velvet Nutella", Description = "red velvet cake pop filled with nutella dipped in milk chocolate", Price = 55000 }
        );
        builder.Entity<Brownie>().ToTable("Brownies").HasData(
            new MenuItem { Id = 10, Name = "Biscoff Blondies", Description = "the moist chewy interior bursting with cookie butter flavor topped with biscoff spread and a lotus biscuit", Price = 73000 },
            new MenuItem { Id = 11, Name = "Brookie", Description = "three layer brownie, with a layer of nutella brownie, layer edible cookie dough and layer chocolate chip cookie topped with nutella", Price = 75000 },
            new MenuItem { Id = 12, Name = "Nutella Brownies", Description = "", Price = 70000 },
            new MenuItem { Id = 13, Name = "Caramel Twix Brownies", Description = "", Price = 70000 }
        );
        builder.Entity<CinnamonRoll>().ToTable("CinnamonRolls").HasData(
            new MenuItem { Id = 14, Name = "Oreo Cinnamon Roll", Description = "", Price = 105000 },
            new MenuItem { Id = 15, Name = "Red Velvet Cinnamon Roll", Description = "", Price = 105000 },
            new MenuItem { Id = 16, Name = "Lotus Cinnamon Roll", Description = "", Price = 105000 },
            new MenuItem { Id = 17, Name = "Nutella Cinnamon Roll", Description = "", Price = 105000 }
        );
        builder.Entity<Cookie>().ToTable("Cookies").HasData(
            new MenuItem { Id = 18, Name = "Churro Cookie", Description = "churros based cookie dough stuffed with premium Belgian chocolate topped with cinnamon and sugar", Price = 70000 },
            new MenuItem { Id = 19, Name = "Chocolate Chip with Cake Pop", Description = "chocolate chip cookie filled with red velvet cake pop", Price = 65000 },
            new MenuItem { Id = 20, Name = "Half Chocolate Chip, Half Red Velvet Cookie", Description = "", Price = 65000 },
            new MenuItem { Id = 21, Name = "Red Velvet", Description = "plain soft red velvet cookie", Price = 65000 },
            new MenuItem { Id = 22, Name = "Red Velvet Oreo", Description = "red velvet cookie filled with oreo", Price = 65000 },
            new MenuItem { Id = 23, Name = "Red Velvet Nutella", Description = "red velvet cookie filled with nutella spread", Price = 65000 },
            new MenuItem { Id = 24, Name = "M&M's", Description = "chocolate chip cookie filled with m&m's", Price = 65000 },
            new MenuItem { Id = 25, Name = "Lotus", Description = "chocolate chip cookie filled with lotus spread", Price = 65000 },
            new MenuItem { Id = 26, Name = "Snickers", Description = "chocolate chip cookie filled with snickers", Price = 65000 },
            new MenuItem { Id = 27, Name = "Mars", Description = "chocolate chip cookie filled with mars", Price = 65000 },
            new MenuItem { Id = 28, Name = "Bueno", Description = "chocolate chip cookie filled with kinder bueno", Price = 65000 },
            new MenuItem { Id = 29, Name = "Twix", Description = "chocolate chip cookie filled with twix", Price = 65000 }
        );
        builder.Entity<Cupcake>().ToTable("Cupcakes").HasData(
            new MenuItem { Id = 30, Name = "Vanilla Buttercream Cupcake", Description = "vanilla buttercream cupcake topped with candy", Price = 60000 },
            new MenuItem { Id = 31, Name = "Layered Red Velvet Cookie Dough Cupcake", Description = "layered red velvet cupcake with raw edible cookie dough between the layers, topped with vanilla buttercream, chunks of cookie dough and drizzled with milk chocolate", Price = 60000 },
            new MenuItem { Id = 32, Name = "Layered Red Velvet Oreo Cupcake", Description = "layered red velvet cupcake with oreo truffle between the layers, topped with oreo truffle and our homemade chcoclate ganache and mini chocolate chips", Price = 62000 }
        );
